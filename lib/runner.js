...
async function createTestFile(connection, untestedFiles, directory, model, testDir) {
...
async function rerunAllTest(sourceFiles, directory, testDir, connection, model) {
