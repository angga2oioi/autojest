...
async function createTestFile(untestedFiles,  testDir) {
...
async function rerunAllTest(sourceFiles,  testDir) {
...
async function runCoverage(directory, testDir, sourceFiles) {
