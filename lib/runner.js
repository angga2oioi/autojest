...
async function createTestFile(connection, untestedFiles, directory, model, maxRetries, testDir) {
...
async function rerunAllTest(sourceFiles, directory, testDir, connection, model, maxRetries) {
...
async function runCoverage(directory, testDir, sourceFiles, connection, model, maxRetries) {
